...
//  */
// const ZERO = new BN(0);
// export const divide10Exp = (origin: BN, pow) => {
//   if (origin.eq(ZERO)) {
//     return '0';
//   }
...
// export const generateGroupName = (bucketName, objName?) => {
//   if (objName) {
...
// export const generateResourceName = (bucketName, objName?) => {
//   if (objName) {
...
// export const defaultImg = (name, width) => {
//   if (!name) return '';
...
// export const contentTypeToExtension = (contentType = '', fileName?) => {
...
// export const directlyDownload = (url) => {
//   if (!url) {
//     toast.error({
...
// export const encodeObjectName = (obj) => {
//   return obj.split('/').map(encodeURIComponent).join('/');
// };

// export const viewFileByAxiosResponse = (result) => {
//   try {
